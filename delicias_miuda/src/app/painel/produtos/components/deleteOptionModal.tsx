...
const DeleteOptionModal: React.FC = () => {
    return (
        <Dialog>
            <DialogTrigger>
            ...
            <DialogContent className='w-1/4 font-sans'>
                <DialogHeader className='border-b-2 border-heavy-rose/70 text-lg'>Deletar opção</DialogHeader>

                <h1>Você tem certeza que deseja deletar essa seção? Essa ação é irreversível!</h1>
